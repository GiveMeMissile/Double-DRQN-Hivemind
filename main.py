...
# 1: Iterations: This is the final step (I hope). I will iterate through the following steps below until the program works as intended. (In Progress)
...
# 2: Change post game learning to be batch based rather than epoch based (Done)

# 3: Improve memory reassembling. (Done)

# 4: Rework rewrad calculations and how boolean values used for rewrad calculations are saved.
...
#   Iter 34: pre eps: 100, post: 50, ais: 1, glues: 0, lr: 0.0001, Discount: 0.9, Other Changes: Fixed collision tracking bug and changed biased epsilon.
#   Iter 34.5: pre eps: 100, post: 50, ais: 1, glues: 0, lr: 0.00001, Discount: 0.9, Other Changes: Fixed data saving errors seen in iter 34
#   Iter 35: pre: 100, post: 50, ais: 1, glues: 5, lr: 0.000005, Discount: 0.9, Other Changes: Changed post game learning and fixed model saving bug.
#   Iter 36: pre: 100, post: 50, ais: 1, glues: 5, lr: 0.000005, Discount: 0.95, Other Changes: Optimized training data saving
#   Iter 37: pre: 100, post: 50, ais: 3, glues: 0, lr: 0.000005, Discount: 0.95, Other Changes: Fixed issues with training optimization. (G)
#   Iter 38: pre: 100, post: 50, ais: 3, glues: 0, lr: 0.000005, Discount: 0.95, Other Changes: Removed action encoding in input. (B)
#   Iter 39: pre: 100, post: 50, ais: 3, glues: 5, lr: 0.000005, Discount: 0.95, Other Changes: Changed post game and readded action encoding and modified rewards.
#   Iter 40: pre: 100, post: 75, ais: 3, glues: 5, lr: 0.000005, Discount: 0.95, Other Changes: Added contact encoding to the AI input
#   Iter 41: pre: 100, ais: 1, glues: 5, lr: 0.000005, Discount: 0.95, Other Changes: None
#   Iter 42: pre: 150, ais: 1, glues: 5, lr: 0.00005, Discount: 0.98, Other Changes: Altered Rewards
#   Iter 43: pre: 150, ais: 1, glues: 5, lr: 0.000005, Discount: 0.98, Other Changes: Fixed a model memory Error...
#   Iter 44: pre: 150, ais: 1, glues: 0, lr: 0.000005, Discount: 0.95, Other Changes: None...
#   Iter 45: pre: 150, ais: 1, glues: 0, lr: 0.000005, Discount: 0.95, Other Changes: Removed the contact encoding
#   Iter 46: pre: 100, ais: 1, glues: 0, lr: 0.000005, Discount: 0.95, Other Changes: Increased model syncing and added training Q value tracking
#   Iter 47: pre: 100, ais: 1, glues: 0, lr: 0.00005, Discount: 0.95, Other Changes: None
#   Iter 48: pre: 100, ais: 1, glues: 0, lr: 0.000005, Discount: 0.95: Other Changes: Fixed some minor bugs Ig Idk I am desperate.
#   Iter 49: pre: 150, ais: 1, glues: 5, lr: 0.000005, Discount: 0.90, Other Changes: NONE
#   Iter 50: pre: 150, ais: 1, glues: 5, lr: 0.000005, Discount: 0.95, Other Changes: Added reward deriving for offline training and changed how some reward values are calculated.
#   Iter 51: pre: 150, ais: 1, glues: 5, lr: 0.000005, Discount: 0.95, Other Changes: Minor Changes to rewards and biases. 


# Notes: 
# Best Learning Rate of Far: 0.000005
# Best Discount so Far: 0.95
# Best Number of Saved Frames: 20
# 
...
def game_loop(progress_tracker, data_manager, curriculum, ai_manager):
    ...
    while running:
        ...
        for ai in ai_manager.ai_list:
            ...
            ai.check_for_glue_collision(glues)
            ai.check_for_ai_collisions(ai_manager.ai_list, current_time)
    ...
    # Code Below is used to save some data used for testing
    # print("Saving Test Sequence...")
    # ai_manager.save_memory("xenon.pkl")
    # print("Done Saving Test Sequence!")
...
if __name__ == "__main__":
    ...
    curriculum = CurriculumManager(init.training, init.curriculum, init.MAX_VELOCITY, init.PLAYER_CONTACT, init.WINDOW_X, init.WINDOW_Y, init.TRAINING_INCREMENT)
    model_number = None
